...
export function DemoControls() {
      ...
      {opts.map((o) => {
        ...
        return (
          <button key={o.k} onClick={() => on(o.k)}
            style={{ border: "none", cursor: "pointer", borderRadius: 999, padding: "5px 11px", fontSize: 10.5, fontWeight: 600, background: active ? "#C9A55F" : "transparent", color: active ? "#0B1129" : "#C4C0B8", whiteSpace: "nowrap", transition: "background .15s, color .15s" }}>
            {o.l}
          </button>
        );
      })}
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 9, background: "rgba(11,17,41,0.95)", border: "1px solid rgba(201,165,95,0.4)", borderRadius: 999, padding: "5px 11px", boxShadow: "0 8px 24px rgba(0,0,0,0.3)", fontFamily: "Inter, system-ui, sans-serif", maxWidth: "96vw", flexWrap: "wrap", justifyContent: "center" }}>
