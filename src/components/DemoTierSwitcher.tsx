...
export function DemoTierSwitcher() {
  ...
  return (
    <div style={{ position: "fixed", top: 54, left: "50%", transform: "translateX(-50%)", zIndex: 150, display: "flex", alignItems: "center", gap: 9, background: "rgba(11,17,41,0.94)", border: "1px solid rgba(201,165,95,0.4)", borderRadius: 999, padding: "5px 8px 5px 13px", boxShadow: "0 10px 34px rgba(0,0,0,0.35)", fontFamily: "Inter, system-ui, sans-serif" }}>
