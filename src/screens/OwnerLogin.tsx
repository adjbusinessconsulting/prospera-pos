...
export default function OwnerLogin() {
  ...
  return (
    <div className="w-full h-full bg-cream-deep flex items-center justify-center overflow-hidden" style={{ padding: "0 20px" }}>
      <div style={{ width: "100%", maxWidth: 460, background: "#FAFAF7", border: "1px solid #ECE7DD", borderRadius: 16, padding: "24px 36px 20px", display: "flex", flexDirection: "column", boxShadow: "0 24px 64px -20px rgba(11,17,41,0.18), 0 4px 16px rgba(11,17,41,0.06)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 16 }}>
          <img src="/horizontal-light.png" alt="Prospera" style={{ height: 52, width: "auto", objectFit: "contain", marginBottom: 12 }} />
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 11 }}>
          ...
          {mode === "signup" && (
            <div>
              ...
              <div className="bg-white border border-warm-border rounded-[10px] flex items-center gap-[10px]" style={{ padding: "0 13px", height: 44 }}
                ...
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#7A776F" strokeWidth="1.8"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                <input type="text" value={storeName} onChange={e => setStoreName(e.target.value)} placeholder="Toko Sembako Maju" required className="flex-1 bg-transparent border-0 outline-none text-navy" style={{ fontSize: 14, padding: 0 }} />
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <div className="bg-white border border-warm-border rounded-[10px] flex items-center gap-[10px]" style={{ padding: "0 13px", height: 44 }}
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="email@toko.id" required className="flex-1 bg-transparent border-0 outline-none text-navy" style={{ fontSize: 14, padding: 0 }} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-white border border-warm-border rounded-[10px] flex items-center gap-[10px]" style={{ padding: "0 13px", height: 44 }}
              ...
              <input type={showPw ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" required className="flex-1 bg-transparent border-0 outline-none text-navy" style={{ fontSize: 14, letterSpacing: showPw ? 0 : "0.1em", padding: 0 }} />
        ...
        <div className="border-t border-warm-border flex justify-between items-center" style={{ marginTop: 14, paddingTop: 12 }}>
          ...
          <div className="font-mono text-text-mute uppercase" style={{ fontSize: 9, letterSpacing: "0.18em" }}>© 2026 PROSPERA</div>
        </div>
      </div>
    </div>
  );
